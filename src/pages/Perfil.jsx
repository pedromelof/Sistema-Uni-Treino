            ...
            <div className="modal-overlay">
              <div className="modal-card">
                ...
                <p className="modal-texto">
                  Digite <strong>"Eu quero excluir a minha conta"</strong> para
                  confirmar.
                </p>
                <input
                  type="text"
                ...
                <div className="modal-acoes">
                  ...
                  <button
                    ...
                    disabled={
                      textoExclusao !== "Eu quero excluir a minha conta"
                    }
                    onClick={() => {
